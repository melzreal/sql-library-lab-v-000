...
VALUES (1, "What a big potato", 1, 1),
(2, "Second Series", 2, 2);

INSERT INTO subgenres (id, name)
VALUES (1, "Food standards"), (2, "Planting stuff");

INSERT INTO authors (id, name)
VALUES (1, "Georger the Farmer"), (2, "Mel Mel");

INSERT INTO books (id, title, year, series_id)
VALUES (1, "Game of Potatoes", 1996, 1), (2, "A Clash of Tubers", 1998, 1),
(3, "A Storm of Sprouts", 2000, 1), (4, "First Book", 2002, 2), (5, "Second Book", 2003, 2), (6, "Third Book", 2005, 2);

INSERT INTO characters (id, name, motto, species, author_id, series_id)
VALUES (1, "Papa", "Papita", "Papito", 1, 1),
(2, "Tyrion Lannister", "A Lannister always pays his debts", "human", 1, 1),
(3, "Daenerys Targaryen", "If I look back I am lost", "human", 1, 1),
(4, "Eddard Stark", "Winter is coming, plant potatoes", "human", 1, 1);
